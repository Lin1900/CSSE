...
#        self.assertTrue(inputVal == output)
    ...
    def test_400_001(self):
        output = SD.dispatch({'op': 'predict','body': 'star', 'date': '2016-01-17', 'time': '03:15:42'})
        self.assertTrue(output == {'op': 'predict', 'body': 'star', 'date': '2016-01-17', 'time': '03:15:42', 'error': 'star not in catalog'})
    ...
    def test_400_004(self):
        ...
        self.assertTrue(output == {'op': 'predict', 'body': 'Betelgeuse', 'date': '2003-4-32', 'time': '03:15:42', 'error': 'date is invalid'})
