...
#        self.assertTrue(inputVal == output)
    ...
    def test_400_011(self):
        output = SD.dispatch({'op': 'predict', 'body': 'Betelgeuse', 'date': '2014-2-21', 'time': '3:15:80'})
        self.assertDictEqual(output, {'op': 'predict', 'body': 'Betelgeuse', 'date': '2014-2-21', 'time': '3:15:80', 'error': 'time is invalid'})
