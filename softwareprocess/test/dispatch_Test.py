...
class DispatchTest(unittest.TestCase):
    ...
    def test6_200_005_exist(self):
        output = SD.dispatch({'op': 'correct', 'lat': '16d32.3', 'long':'95d41.6', 'altitude': '13d42.3', 'assumedLat': '-53d38.4'})
        self.assertDictEqual(output, {'op':'correct', 'lat':'16d32.3', 'long':'95d41.6', 'altitude':'13d42.3', 'assumedLat':'-53d38.4', 'error': 'Mandatory information is missing'})

    def test6_200_006_InputInvalid(self):
        output = SD.dispatch({'op': 'correct', 'lat': '16d32.3', 'long': '95d41.6', 'altitude': '13d42.3', 'assumedLat': 42, 'assumedLong': '74d35.3'})
        self.assertDictEqual(output, {'op':'correct', 'lat': '16d32.3', 'long': '95d41.6', 'altitude':'13d42.3', 'assumedLat': 42, 'assumedLong': '74d35.3', 'error': 'input is invalid'})

    def test6_200_007_mis(self):
        output = SD.dispatch({'op': 'correct', 'lat': '16d32.3', 'long': '95d41.6', 'altitude': '13d42.3', 'assumedLat': '91d38.4', 'assumedLong': '74d35.3'})
        self.assertDictEqual(output, {'op':'correct', 'lat': '16d32.3', 'long': '95d41.6', 'altitude':'13d42.3', 'assumedLat': '91d38.4', 'assumedLong': '74d35.3', 'error': 'assumedLat is invalid'})

    def test6_200_008_mis(self):
        output = SD.dispatch({'op': 'correct', 'lat': '16d32.3', 'long': '95d41.6', 'altitude': '13d42.3', 'assumedLat': '-53d38.4', 'assumedLong': '74d-15.3'})
        self.assertDictEqual(output, {'op':'correct', 'lat': '16d32.3', 'long': '95d41.6', 'altitude':'13d42.3', 'assumedLat': '-53d38.4', 'assumedLong': '74d-15.3', 'error': 'assumedLong is invalid'})
