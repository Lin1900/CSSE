...
class DispatchTest(unittest.TestCase):
    ...
    def test6_100_001_caculate(self):
        ...
        self.assertDictEqual(output, {'op':'correct', 'lat':'16d32.3', 'long':'95d41.6', 'altitude':'13d42.3', 'assumedLat':'-53d38.4', 'assumedLong':' 74d35.3', 'correctedDistance':'3950', 'correctedAzimuth': '164d43.1'})
