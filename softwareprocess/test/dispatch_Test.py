...
#        self.assertTrue(inputVal == output)
    ...
    def test_400_004(self):
        output = SD.dispatch({'op': 'predict', 'body': 'Betelgeuse', 'date': '2016-11-17', 'time': '21:-22:1'})
    ...
    def test_400_0011(self):
        input = {'op': 'predict', 'body': 'Betelgeuse', 'date': '2011-01-17', 'time': '03:5:42'}
        output = {'op': 'predict', 'body': 'Betelgeuse', 'date': '2011-01-17', 'time': '03:5:42', 'error': 'time is invalid'}
        self.assertDictEqual(SD.dispatch(input), output)

    def test_400_0012(self):
        input = {'op': 'predict', 'body': 'Betelgeuse', 'date': '2002-02-29', 'time': '03:15:42'}
        output = {'op': 'predict', 'body': 'Betelgeuse', 'date': '2002-02-29', 'time': '03:15:42', 'error': 'date is invalid'}
        self.assertDictEqual(SD.dispatch(input), output)
